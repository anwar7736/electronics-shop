...
return [
    ...
    'contact_no' => 'কন্টাক্ট নাম্বার.',
    'commission_agent' => 'Commission Agent',
    'cmmsn_percent' => 'বিক্রির কমিশন শতকরা (%)',
    ...
    'add_stock_transfer' => 'নতুন স্টক স্থানান্তর',
    'list_stock_transfers' => 'List Stock Transfers',
    'location_from' => 'ঠিকানা (থেকে)',
    'location_to' => 'ঠিকানা (চেয়ে)',
    ...
    'customer_groups' => 'ক্রেতার গ্রুপসমূহ',
    'customer_group' => 'ক্রেতার গ্রুপ',
    'all_your_customer_groups' => 'সকল ক্রেতার গ্রুপসমূহ',
    'add_customer_group' => 'Add Customer Group',
    'customer_group_name' => 'ক্রেতার গ্রুপের নাম',
    'calculation_percentage' => 'ক্যালকুলেশন শতকরা (%)',
    ...
    'none' => 'None',
    'enable_imei_or_sr_no' => 'পণ্যের বিবরণ, আইএমই অথবা সিরিয়াল নাম্বার সচল রাখুন',
    ...
    'unit_cost_before_discount' => 'ইউনিট খরচ (ডিসকাউন্ট এর পূর্বে)',
    ...
    'enter_product_name_to_print_labels' => 'লেভেল প্রিন্ট করার জন্য পণ্যের নাম লিখুন ',
    'manage_product_variations' => 'পণ্যের ভেরিয়েশনস ম্যানেজ করুন',
    'all_variations' => 'সকল ভেরিয়েশনসমূহ',
    'values' => 'ভ্যালুসমূহ',
    'add_variation' => 'ভেরিয়েশন তৈরি',
    ...
    'pending' => 'Pending',
    'ordered' => 'Ordered',
    'search_product_placeholder' => 'পণ্যের নাম / এসকেইউ / বারকোড স্ক্যান করুন',
    'fixed' => 'Fixed',
    ...
    'other' => 'Other',
    'payment' => 'Payment',
    'total_items' => 'মোট উপাদানসমূহ',
    'total_paying' => 'Total Paying',
    'balance' => 'Balance',
    'payment_method' => 'পেমেন্ট করেছেন',
    'card_no' => 'Card Number',
    ...
    'printer_model_help' => 'Short Descriptive Model to recognize printer',
    ...
    'unit_perchase_price' => 'ইউনিট ক্রয়ের দাম',
    ...
    'manage_products' => 'আপনার পণ্য ম্যানেজ করুন',
    'all_products' => 'সকল পণ্যসমূহ',
    'login' => 'লগ ইন',
    'register' => 'রেজিষ্টার',
    'username' => 'ইউজারনেম',
    'password' => 'পাসওয়ার্ড',
   ...
   'import_opening_stock' => 'ওপেনিং স্টক ইমপোর্ট করুন',
   ...
   'all_sales' => 'সকল বিক্রিসমূহ',
   'opening_balance' => 'Opening Balance',
   'opening_balance_due' => 'Opening Balance Due',
   'import_contacts' => 'কন্টাক্টসমূহ ইমপোর্ট',
   ...
   'selling_price_group' => 'বিক্রির দামের গ্রুপ',
   'all_selling_price_group' => 'সকল পণ্য বিক্রির গ্রুপ',
   ...
   'payment_paid_notification' => 'Payment Paid Notification',
    ...
    'all_purchase_returns' => 'সকল ক্রয়ের ফেরত',
    'parent_purchase' => 'প্রধান ক্রয়',
    ...
    'total_purchase_return_due' => 'মোট ক্রয়ের ফেরতের বাকী',
    ...
    'sell_due' => 'বিক্রি বাকী',
    'sell_return_due' => 'বিক্রি বাকী ফেরত',
    'total_sell_return_due' => 'মোট বিক্রির ফেরত বাকী',
    ...
    'sales_payment_dues' => 'বিক্রির টাকার বাকী',
    'purchase_payment_dues' => 'ক্রয়ের টাকার বাকী',
    ...
    'years' => 'Years',
    'no_of_repetitions' => 'রিপিটিশন সংখ্যা',
    ...
    'generated_invoices' => 'তৈরিকৃত চালানসমূহ',
    'last_generated' => 'সর্বশেষ তৈরিকৃত',
    'upcoming_invoice' => 'চালান আসিতেছে',
    ...
    'combo' => 'Combo',
    'not_for_selling' => 'বিক্রির জন্য নয়',
    ...
    'download_template_file' => 'ডেমো ফাইল ডাউনলোড করুন',
    ...
    'shipping_status' => 'শিপিং স্থিতি',
    'delivered_to' => 'যাকে পাঠাবেন',
    ...
    'import_export_selling_price_group_prices' => 'ইমপোর্ট/এক্সপোর্ট বিক্রির দামের গ্রুপ',
    'export_selling_price_group_prices' => 'এক্সপোর্ট বিক্রির দামের গ্রুপ',
    ...
    'price_group_import_istruction' => 'এক্সপোর্ট বিক্রির দামের গ্রুপ',
    'price_group_import_istruction1' => 'এক্সপোর্ট করা ফাইলটি পরিবর্তন করুন এবং সেই ফাইলটি ইমপোর্ট করুন',
    'price_group_import_istruction2' => 'শুধুমাত্র পণ্য বিক্রির দামের গ্রুপসমূহ পরিবর্তিত হবে । যেকোন খালি দামের ঘর বাদ যাবে',
    ...
    'total_stock_price' => 'বর্তমান স্টক দাম',
    ...
    'warranty' => 'Warranty',
    'warranties' => 'ওয়ারেন্টিসমূহ',
    'all_warranties' => 'সকল ওয়ারেন্টিসমূহ',
    ...
    'import_sales' => 'বিক্রিসমূহ ইমপোর্ট করুন',
    ...
    'upload_and_review' => 'পাঠান এবং দেখুন',
    ...
    'all_your_discounts' => 'আপনার সকল ডিসকাউন্টসমূহ',
    'priority' => 'অগ্রাধিকার',
    'starts_at' => 'শুরু',
    'ends_at' => 'শেষ',
    ...
    'recur_interval' => 'রিকারিং ইন্টারভাল',
    ...
    'advance' => 'Advance',
    'advance_balance' => 'এডভান্স ব্যালেন্স',
    ...
    'upcoming' => 'Upcoming',
    'final' => 'Final',
    'expense_for_contact' =>  'ব্যয়ের জন্য যোগাযোগ',
    'create' => 'Create',
    'waiting' => 'Waiting',
    ...
    'billing_address' => 'বিলিং অ্যাড্রস',
    'delete_sell' => 'Delete Sell',
    'product_brochure' => 'পণ্যের ব্রুশেয়ার',
    ...
    'shipping_documents' => 'শিপিং ডকুমেন্টসমূহ',
    ...
    'packing_date' => 'প্যাকেটের তারিখ',
    'print_exp_date' => 'Print expiry date',
    'print_packing_date' => 'প্যাকিং তারিখ প্রিন্ট',
    'print_lot_number' => 'লট নাম্বার প্রিন্ট',
    ...
    'keep_blank_to_autogenerate' => 'ফাঁকা রাখুন অটোমেটিক তৈরি হবে',
];
